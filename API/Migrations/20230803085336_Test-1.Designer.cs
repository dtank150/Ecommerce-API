...
namespace API.Migrations
{
    ...
    [Migration("20230803085336_Test-1")]
    partial class Test1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerBasketProduct", b =>
                {
                    b.Property<int>("CustomerBasketsId")
                        .HasColumnType("int");

                    b.Property<int>("ItemsId")
                        .HasColumnType("int");

                    b.HasKey("CustomerBasketsId", "ItemsId");
            ...
            modelBuilder.Entity("CustomerBasketProduct", b =>
                {
                    b.HasOne("API.Entities.CustomerBasket", null)
                        .WithMany()
                        .HasForeignKey("CustomerBasketsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
